    ...
    <section className={styles.softwareSection}>
      ...
      <div className={`${styles.slide} ${styles.div1} ${showFirst ? styles.active : styles.fadeOutSection}`}>
        ...
        <div className={styles.laptopWrapper}>
          <img
            src={"src/assets/lottiefiles.com/animations/computerztech-lhmk6qciBg.png"}
            alt="Laptop"
      ...
      <div ref={cloudRef} className={`${styles.slide} ${styles.container} ${cloudFadeClass}`}>
...
{/* Ozias(start) */}
        ...
        <div className={styles.div2_3}>
            <img src={"src/assets/computerztech-lhmk6qciBg.png"} alt="" className={styles.laptop} />
        </div>
            </div>
        {/* Ozias(End) */}
      {/* Slide 3 (ECommerce) */}
      <div className={`${styles.slide} ${styles.div3}`}>
        <div className={styles.ecommerceContainer}>
          <h1
            ref={titleRef}
            className={`${styles.ecommerceTitle} ${isTitleVisible ? styles.visibleFade : styles.fadeOnScroll}`}
          >
            E-COMMERCE
          </h1>
          ...
          <div className={styles.ecommerceSection}>
            <div className={styles.ecommerceLeftSection}>
              <img
                ...
                className={`${styles.ecommerceMainImage} ${isFirstImageVisible ? styles.visibleFade : styles.fadeOnScroll}`}
              />
            </div>
            ...
            <div className={styles.ecommerceRightSection}>
              <p
                ref={descriptionRef}
                className={`${styles.ecommerceDescription} ${isDescriptionVisible ? styles.visibleFade : styles.fadeOnScroll}`}
              >
          ...
          <div className={styles.ecommerceSection}>
            ...
            <div className={styles.ecommerceRightSection}>
              <img
                ...
                className={`${styles.ecommerceMainImage} ${styles.fadeInFromBottom} ${
          ...
          >
            <img
              ...
              alt="Laptop"
              className={`${styles.ecommerceLaptopImage} ${isLaptopImageVisible ? styles.visibleFade : styles.fadeOnScroll}`}
            />
          </motion.div>
        </div>
      </div>
